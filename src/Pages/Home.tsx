...
export const Home = () => {
  return (
    <div className="flex flex-col gap-10 items-center m-10 font-times">
      ...
      <div className="flex flex-col mt-4 border-l p-4">
        <h1 className="text-6xl sm:text-9xl pr-4 text-white italic">Ijatu Mystery</h1>
  ...
  <div className="mt-4">
    <p className="text-2xl font-extralight italic text-gray-500">
      O que espera por você:
    </p>
    <ul className="sm:flex sm:flex-row w-2xl flex-col items-center justify-center gap-4 bg-gray-300 border-none rounded-lg m-1 p-2">
