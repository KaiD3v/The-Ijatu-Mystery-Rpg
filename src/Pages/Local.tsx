    ...
    <div>
      {selectedLocal ? (
        <div className="flex flex-col gap-4 justify-center items-center m-10">
          <h1 className="text-2xl mt-4 font-semibold text-gray-200">{selectedLocal.title}</h1>
          <img
            src={selectedLocal.image}
            alt={selectedLocal.title}
            className="mb-4 max-w-4xl rounded-md shadow-md"
          />
          <div
          ...
          <div>
            <h1 className="text-2xl font-semibold mb-2 text-gray-200">Mapa Local</h1>
            <img
